...
const Katalog = () => {
  ...
  const [hoveredTelevozorlar, setHoveredTelevizorlar] = useState(false);
  let exit = useNavigate()

  return (
    <div className=" absolute z-50 w-screen pt-[90px] rounded-2xl mx-auto">
      <div className="flex gap-[30px] fixed bg-white p-2 w-[1400px] mx-auto rounded-2xl">
        <div className="flex flex-col gap-2">
          <div
            ...
            onMouseEnter={() => {
              ...
              setHoveredTelevizorlar(false)
            }}
            style={{
              backgroundColor: hoveredSmartfonlar ? "#ed4040" : "transparent",
              color: hoveredSmartfonlar ? "white" : "red",
            }}
          >
          ...
          <div
            ...
            onMouseLeave={() => setHoveredKampyuterlar(false)}
            style={{
              backgroundColor: hoveredKampyuterlar ? "#ed4040" : "transparent",
              color: hoveredKampyuterlar ? "white" : "red",
            }}
          >
            <div className="flex items-center">
              <img
          ...
          onMouseEnter={() => {
            setHoveredSmartfonlar(false);
            setHoveredKampyuterlar(false);
            setHoveredTelevizorlar(true)
          }}
          style={{
            backgroundColor: hoveredTelevozorlar ? "#ed4040" : "transparent",
            color: hoveredTelevozorlar ? "white" : "red",

          }}
          onMouseLeave={() => setHoveredTelevizorlar(false)}
          >
            <div className="flex items-center">
              <img
        ...
        <div className="w-[900px]">
          ...
          <button className="border px-2 py-3" onClick={()=>exit(-1)}>exit</button>
        </div>
      </div>
    </div>
  );
